...
from src.BayesianDI.physics import angular_distance, get_full_design_matrix
...
def run_mcmc_estimation(d, wl, line_profile, obs_times, dmat, nside, key_seed=0):
    ...
    def model_viu(data):
        ...
        P = numpyro.sample('P', dist.Uniform(4.8, 5.4)) #
...
def main():
    ...
    # 5. Save Results
    results_file = output_path / f"mcmc_chip{chip_idx}_results.npz"
